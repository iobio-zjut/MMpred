...
public:
	...
	int N, G_explore, G_maintain, G_enhance_c, Crowding_radius_exp, Crowding_radius_mer;
	...
	void Kmediods(int, vector<vector<double> > Distance_Matrix);
	vector< vector<int> > best_every_cluster;
	
	vector<core::pose::Pose> All_pose;
	vector< core::pose::Pose > Initial_population(core::pose::Pose &pose);
	
	void DMscore_and_cluster(vector<core::pose::Pose> &storage_pose);
	double DM_score( core::pose::Pose &pose, core::pose::Pose &tempPose );
	void final_enhence(vector< vector<core::pose::Pose> > Vec_modal);
...
//=======================================================================================	
	...
	void Multimodal_explore(vector<core::pose::Pose> &storage_pose, vector< double >& population_Dscore, vector< vector<double> > &DMscore_map);
	void Multimodal_maintain(vector<core::pose::Pose> &population, vector< double >& population_energy, vector< double >& population_Dscore);
	...
	void Multimodal_enhance_c(vector<core::pose::Pose> &population, vector<double> &population_energy, vector<double> &population_Dscore, int enhance_g);
	...
	vector<double> calculate_population_Dscore(vector<core::pose::Pose> &population);
...
//=======================================================================================
	...
	vector<core::pose::Pose> Enhance_population;
	void Enhance();
